...
plotVF_disp(X,Y,u1vb,u2vb,1,path_results,fname)
fname = 'vfm_tutorial_pw_optim_vfs_epsstar_b'
plotVF_strain(X,Y,eps1vb,eps2vb,eps6vb,1,path_results,fname)
fname = 'vfm_tutorial_pw_optim_vfs_ustar_c'
plotVF_disp(X,Y,u1vc,u2vc,1,path_results,fname)
fname = 'vfm_tutorial_pw_optim_vfs_epsstar_c'
plotVF_strain(X,Y,eps1vc,eps2vc,eps6vc,1,path_results,fname)
fname = 'vfm_tutorial_pw_optim_vfs_ustar_d'
plotVF_disp(X,Y,u1vd,u2vd,1,path_results,fname)
fname = 'vfm_tutorial_pw_optim_vfs_epsstar_d'
plotVF_strain(X,Y,eps1vd,eps2vd,eps6vd,1,path_results,fname)
